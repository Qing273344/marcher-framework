...
public final class StringUtil {
	...
	/******************************************************************************************************************* 判断 ***********************/
	/**
	 * 判断字符串是否为空，如果为true则为空。与isEmpty不同，如果字符为" "也视为空字符
	 * @param str	字符串
	 * @return
	 */
	...
	/**
	 * 判断字符串是否为空，如果为true则不为空。与isNotEmpty不同，如果字符为" "也视为空字符
	 * @param str	字符串
	 * @return
	 */
	 ...
	 * @param string	字符串
	 * @param length	要取的字长度，此为中文长度，英文仅当作半个字符。
	...
	/**
	 * 把某一个字符变成大写或小写 作者：李建 时间：Dec 17, 2010 9:39:32 PM
	 * @param str		字串
	 * @param index		第几个字符
